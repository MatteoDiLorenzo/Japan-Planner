...
import { formatEurFromJpy } from '@/lib/currency';
...
export function Navbar({ activeSection, onSectionChange }: NavbarProps) {
  ...
  // Close mobile menu when clicking outside (escludi il pulsante hamburger/X nel nav)
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-[500] bg-black/80 backdrop-blur-md border-b border-white/10">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative hidden sm:block" ref={weatherRef}>
                ...
                {/* Weather Card */}
                {showWeatherCard && (
                  <div className="absolute top-full right-0 mt-2 w-72 bg-black/95 backdrop-blur-xl rounded-2xl p-4 border border-white/20 shadow-2xl z-[550]">
              ...
              {/* Mobile Menu Button — non usare toggle: altrimenti mousedown "fuori" + click riaprono il menu */}
              <Button
                variant="ghost"
                size="icon"
                className="mobile-menu-trigger md:hidden text-white hover:bg-white/10"
      ...
      {isMobile && (
        <div 
          className={`mobile-menu-container fixed inset-0 z-[480] transition-opacity duration-300 ${
        ...
        >
          ...
          >
            <div className="px-4 py-4 space-y-1">
              ...
              {/* Mobile Weather */}
              <div className="flex flex-col gap-1 px-4 py-3 text-white/70">
                <div className="flex items-center gap-3">
                  {getWeatherIcon()}
                ...
                <p className="text-white/45 text-xs pl-8">
                  Ora JST:{' '}
                  {new Date().toLocaleTimeString('it-IT', {
                    timeZone: 'Asia/Tokyo',
                    hour: '2-digit',
